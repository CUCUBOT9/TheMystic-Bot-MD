...
/* Creditos a CUCU DESING (https://wa.me/593982550410) */
...
const connectionOptions = {
    ...
    mobile: MethodMobile,
    browser: opcion === '1' ? ['Cucu bot-Bot-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['Cucu bot-Bot-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
    auth: {
        creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `• Activo: ${uptime} | Cucu bot-Bot-MD`;
