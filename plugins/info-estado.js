...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const Message = {
    document: { url: `https://github.com/BrunoSobrino/Cucu bot-Bot-MD` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/BrunoSobrino/Cucu bot-Bot-MD",
        mediaType: 2,
        previewType: "pdf",
        title: "CUCU BOT",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://github.com/BrunoSobrino/Cucu bot-Bot-MD",
      },
    },
    caption: info,
    footer: wm,
